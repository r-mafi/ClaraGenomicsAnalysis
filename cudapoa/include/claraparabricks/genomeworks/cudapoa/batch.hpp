...
struct BatchConfig
{
    ...
    BatchConfig(int32_t max_seq_sz = 1024, int32_t max_seq_per_poa = 100, int32_t band_width = 256, BandMode banding = BandMode::full_band, float adapive_storage_factor = 2.0f)
        ...
        , band_mode(banding)
    {
        ...
        else // BandMode::adaptive_band
        {
            ...
            matrix_sequence_dimension = cudautils::align<int32_t, 4>(adapive_storage_factor * (alignment_band_width + 8));
        }
